  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    bindEvents: function() {
      ...
      ionic.onGesture('dragstart', function(e) {
        ...
        //   console.log("transforming right")
        //   self._transformOriginRight();
        // } else {
        //   console.log("transforming left")
            ...
            onPartialSwipe: function(amt) {
              $timeout(function() {
                ...
                if (amt < 0) {
                  ...
                  document.querySelector('.yes-text').style.opacity = 0;
                } else if (amt > 0) {
                  document.querySelector('.yes-text').style.opacity = 100;
                 document.querySelector('.no-text').style.opacity = 0;
                } else {
        document.querySelector('.yes-text').style.opacity = 0;
                 document.querySelector('.no-text').style.opacity = 0;
                }
